...
@pytest.mark.parametrize(
    "total_vram, used, remaining, requests, expected",
    [
        (15, 6, 15, [(1, 10, ProcessStage.DECODE, 5), (1, 10, ProcessStage.PREFILL, 0)], True),
        (15, 5, 15, [(1, 10, ProcessStage.DECODE, 4), (1, 10, ProcessStage.PREFILL, 0)], True),
        (15, 4, 15, [(1, 10, ProcessStage.DECODE, 3), (1, 10, ProcessStage.PREFILL, 0)], False),
        (15, 3, 15, [(1, 10, ProcessStage.DECODE, 2), (1, 10, ProcessStage.PREFILL, 0)], False),
    ]
)
def test_is_valid_step_with_predict(
    total_vram,
    used,
    remaining,
    requests,
    ...
    gpu_view.remaining_vram_slots = remaining
